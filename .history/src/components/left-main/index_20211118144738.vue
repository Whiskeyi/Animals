<template>
  <div class="leftContainer">
    <el-row :gutter="20" type="flex" justify="center" v-for="(i, inx) in dataLength/4" :key="inx">
...
export default {
  ...
  methods: {
     getNum(inx){
        window.console.log(this.Farea.slice(inx,inx+4))
       return this.Farea.slice(inx,inx+4)
      }
    }
  }
</script>
