<template>
  <div class="home">
    <!-- 背景+光泽效果 -->
    <div class="bg" style="background-color: rgb(158, 122, 122);">
      <Gloss></Gloss>
    </div>
    <!-- 页面容器 -->
    <div class="container">
...
export default {
  ...
  created() {
    setInterval(function() {
      ...
      document.getElementsByClassName('bg').style.background-color = 'arrColor[Math.floor(Math.random() * arrColor.length) - 1]'
    }, 3000);
  }
}
</script>
