...
export default {
  ...
  methods: {
    changeBgColor() {
      ...
      setTimeout(function() {
        console.log(arrColor[Math.floor(Math.random()*arrColor.length)-1])
        //  document.getElementsByClassName("bg").style.background-color = arrColoe[Math.floor(Math.random()*arrColor.length)]
      }, 3000);
    }
  }
}
